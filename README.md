...
### NOTES
1. To install face_recognition library, you need to install C++ CMake Tools first. You can follow [this instruction](https://www.youtube.com/watch?v=TC_LPpa7uj0) to install C++ CMake Tools First.
